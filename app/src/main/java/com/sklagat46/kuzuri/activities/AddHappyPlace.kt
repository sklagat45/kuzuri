package com.sklagat46.kuzuri.activities
...
import com.sklagat46.kuzuri.utils.GetAddressFromLatLng
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlace, "Failed!", Toast.LENGTH_SHORT)
                                .show()
                    }
                }
